...
var TabsPage = /** @class */ (function () {
    function TabsPage(navCtrl, events, modalCtrl, navParams) {
    ...
    __decorate([
        ...
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Tabs */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Tabs */]) === "function" && _a || Object)
    ...
    TabsPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */]) === "function" && _e || Object])
    ], TabsPage);
    return TabsPage;
    var _a, _b, _c, _d, _e;
}());
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage.prototype.ionViewDidEnter = function () {
        ...
        this.platform.ready().then(function () {
            _this.sqlite.create({
                ...
                .then(function (db) {
                db.executeSql("select * from login_type ORDER BY id DESC LIMIT 0,1", {}).then(function (data) {
                    console.log("查询数据库");
                    console.log(data);
                    if (data.rows.item(0).login_type = 1) {
                        _this.login_type = true;
                    }
                    else {
                        _this.login_type = false;
                    }
                }, function (error) {
                    console.log('查询错误');
                });
    ...
    ContactPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Platform */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_native_call_number__["a" /* CallNumber */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_native_call_number__["a" /* CallNumber */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_native_sqlite__["a" /* SQLite */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_native_sqlite__["a" /* SQLite */]) === "function" && _e || Object])
    ], ContactPage);
    return ContactPage;
    var _a, _b, _c, _d, _e;
}());
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, storage, cdRef, alertCtrl, toastCtrl, platform, sqlite) {
        this.navCtrl = navCtrl;
        this.storage = storage;
        this.cdRef = cdRef;
    ...
    LoginPage.prototype.change = function (value) {
            ...
            toast.onDidDismiss(function () {
                ...
                _this.platform.ready().then(function () {
                    _this.sqlite.create({
                        ...
                        .then(function (db) {
                        db.executeSql("select * from login_type where phone_number='" + _this.phone_number + "'", {}).then(function (data) {
                            console.log("查询数据库号码账号是否存在");
                            console.log(data);
                            if (data.rows.length == 0) {
                                db.executeSql("INSERT INTO login_type ('login_type','phone_number') VALUES (?,?);", ['1', _this.phone_number])
                                    .then(function () { return console.log('号码存入成功'); })
                                    .catch(function (e) { return console.log(e); }); //插入数据
                            }
                            else {
                                console.log("有登录记录");
    ...
    LoginPage.prototype.backbtn = function () {
        var type = 2;
        console.log("back");
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_4__tabs_tabs__["a" /* TabsPage */], { tabtype: type });
        //	this.navCtrl.pop();
    };
    LoginPage.prototype.get_countdown = function () {
        ...
        if (!myreg.test(this.phone_number)) {
            ...
            this.countdown = 60;
            var countime_1 = setInterval(function () {
                --_this.countdown;
                if (_this.countdown <= 1) {
                    clearInterval(countime_1);
    ...
    __decorate([
        ...
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Tabs */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Tabs */]) === "function" && _a || Object)
    ], LoginPage.prototype, "mytab", void 0);
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"F:\wwwroot\shuidi\src\pages\login\login.html"*/'<ion-header>\n\n  <ion-navbar hideBackButton>\n\n  	<ion-buttons left>\n\n      <button ion-button (click)="backbtn()">\n\n        <ion-icon class="customIcon" name="arrow-back"></ion-icon>\n\n        	&nbsp;返回\n\n      </button>\n\n   </ion-buttons>\n\n    <ion-title>\n\n            登录\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content class="content">\n\n	<h2 class="login_title">你好，请登录/注册</h2>\n\n	<div class="login_input">\n		<ion-input class="phone_number" [(ngModel)]="phone_number" type="number" (ngModelChange)="change($event)" placeholder="请输入手机号码"></ion-input>\n\n		<ion-input class="ver_cord" [(ngModel)]="ver_cord" type="text" placeholder="请输入验证码"></ion-input>\n\n		<button class="ver_btn" (click)="get_countdown()" [disabled]="count_type" >{{countdown}}<span *ngIf="count_type">s</span></button>\n\n		<p class="help_text">收不到验证码？</p>\n\n		<button class="sub_btn" ion-button block round (click)="login()">登录</button>\n\n	</div>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\wwwroot\shuidi\src\pages\login\login.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ToastController */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* Platform */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_native_sqlite__["a" /* SQLite */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_native_sqlite__["a" /* SQLite */]) === "function" && _h || Object])
    ], LoginPage);
    return LoginPage;
